...
Research-focused CS grad student interested in NLP and large language models, with an emphasis on structured representations and memory-aware, context-sensitive modeling for intelligent agents.

- Location: Bethlehem, PA, USA
- Email: rul325@lehigh.edu
- GitHub: https://github.com/RuineLiu/RuineLiu

## Research Interests
Natural Language Processing and Large Language Models; structured representations; memory-aware and context-sensitive modeling for intelligent agents.

## Education
**Lehigh University** — M.S. in Computer Science (Expected June 2027)

**North China University of Water Resources and Electric Power (NCWU)** — B.S. in Computer Science and Technology (Jun 2025)  
...
## Honors and Awards
- National Encouragement Scholarship (2024, 2023)
- Third Prize — 17th China Collegiate Computer Design Competition (Henan Provincial, 2024)
- Multiple university-level awards in innovation and programming contests (2021–2023)
